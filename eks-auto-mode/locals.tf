locals {
  ...
  cluster_name               = "eks-${local.project_name}"
  ...
  iam_policy_automode_name   = "iam-pol-${local.project_name}-automode"
  ...
  eks_cluster_log_group_name = "/aws/eks/${local.cluster_name}/cluster"
